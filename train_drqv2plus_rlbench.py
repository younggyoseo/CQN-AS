...
from rlbench_src.replay_buffer import ReplayBufferStorage, make_replay_loader
...
@hydra.main(config_path="cfgs", config_name="config_drqv2plus_rlbench")
def main(cfg):
    from train_drqv2plus_rlbench import Workspace as W
