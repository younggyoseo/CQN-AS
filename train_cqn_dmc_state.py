...
import dmc_src.dmc_state_env as dmc_env
import utils
from logger import Logger
from dmc_src.replay_buffer import ReplayBufferStorage, make_replay_loader
...
def make_agent(obs_spec, action_spec, cfg):
    cfg.low_dim_obs_shape = obs_spec.shape
...
class Workspace:
    ...
    def setup(self):
        # create envs
        self.train_env = dmc_env.make(
            self.cfg.task_name,
            self.cfg.action_repeat,
            self.cfg.seed,
        )
        self.eval_env = dmc_env.make(
            self.cfg.task_name,
            self.cfg.action_repeat,
            self.cfg.seed,
        )
...
@hydra.main(config_path="cfgs", config_name="config_cqn_dmc_state")
def main(cfg):
    from train_cqn_dmc_state import Workspace as W
