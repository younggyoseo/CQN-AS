...
from humanoid_src.replay_buffer import ReplayBufferStorage, make_replay_loader
from video import TrainVideoRecorder, VideoRecorder

torch.backends.cudnn.benchmark = True


def make_agent(low_dim_obs_spec, action_spec, cfg):
...
class Workspace:
    ...
    def train(self):
        ...
        ), "HumanoidBench does not support action repeat"
...
@hydra.main(config_path="cfgs", config_name="config_cqn_humanoid")
def main(cfg):
    from train_cqn_humanoid import Workspace as W
