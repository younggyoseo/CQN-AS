...
from bigym_src.replay_buffer import ReplayBufferStorage, make_replay_loader
from video import TrainVideoRecorder, VideoRecorder

torch.backends.cudnn.benchmark = True


def make_agent(rgb_obs_spec, low_dim_obs_spec, action_spec, cfg):
...
@hydra.main(config_path="cfgs", config_name="config_cqn_bigym")
def main(cfg):
    from train_cqn_bigym import Workspace as W
