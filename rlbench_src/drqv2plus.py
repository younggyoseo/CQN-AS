"""
DrQ-v2+ baseline introduced in our paper.
The difference to original DrQ-v2+ is:
- (i) Supports BC objective
- (ii) Supports distributional critic
- (iii) Supports low-dimensional inputs
"""
